"""System tray icon for Pix42 daemon mode."""
...
class TrayIcon(QSystemTrayIcon):
    ...
    show_window_requested
        ...
        (double-click on the tray icon, or "Open Pix42" menu action).
    quit_requested
    ...
    def __init__(self, icon: QIcon, parent=None) -> None:
        ...
        menu = QMenu()
        open_action = menu.addAction("Open Pix42")
